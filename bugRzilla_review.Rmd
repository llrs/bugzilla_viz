...
Some of the resolution the are not assigned to any category like fixed, duplicate, etc. by assigning them a category, it will help the developer to ensure the status of the bug and it will make the bug report much efficient.
<font>
