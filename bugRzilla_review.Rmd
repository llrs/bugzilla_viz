...
The Time-series graph is the relationship between the `bug_count` and the `year`, `month` & `week`, with the help of those illustrated graphs one can correlate the ratio of changes to code base with the volume of bugs encountered for that change, this gives us the rate of efficiency developing over time.
<font>
