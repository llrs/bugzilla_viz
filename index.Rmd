...
So the question is who is contributing so much. Who are the most contributing users and how are they contributing? I'll focus on the last 3 years (before the acquisition of data)
...
history <- rbind(opener, commenter, attacher)
# Select last 3 years of data
begin <- max(history$time, na.rm = TRUE) - lubridate::years(3)
