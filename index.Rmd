...
# Time since opened and not closed
a1 %>% filter(!closed) %>% 
  mutate(b = difftime(as.Date("2021/03/25"), creation_t, units = "hours")) %>% pull(b) %>% quantile()
# Which types of question tend to be left open?
```
